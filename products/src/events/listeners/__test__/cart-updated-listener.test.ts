...
import { CartUpdatedEvent, ProductSize } from '@admodosdesign/common'

import { CartUpdatedListener } from '../cart-updated-listener'
import { natsWrapper } from '../../../nats-wrapper'
import { Product } from '../../../models/product'

const setup = async () => {
  const listener = new CartUpdatedListener(natsWrapper.client)
